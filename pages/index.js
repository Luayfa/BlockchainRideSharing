    ...
    <Wrapper>
      ...
      <ActionItems>
        <Header>
          ...
          <Block src="https://i.ibb.co/84stgjq/uber-technologies-new-20218114.jpg"/>
...
const Wrapper = tw.div`
  flex flex-col bg-black h-screen
  `
...
const Profile = tw.div`
  ...
  `
const Name = tw.div`
    mr-4 w-20 text-sm text-white font-bold
    `
...
h-20 bg-gray-200 text-2xl p-4 items-center rounded-full
  `